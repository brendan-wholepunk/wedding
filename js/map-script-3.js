...
'use strict';		
	...
	function initialize() {
		...
		//=======================================================================================
  		var mapOptions = {
    		...
    		center: new google.maps.LatLng(48.3571061, -123.6519244),
			panControl: true,
  			zoomControl: true,
  			mapTypeControl: true,
  			//scaleControl: false,
		...
		var marker1 = new MarkerWithLabel({
       		position: new google.maps.LatLng(48.3571061, -123.6519244),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
		...
		var marker2 = new MarkerWithLabel({
       		position: new google.maps.LatLng(48.354144, -123.643167),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
         	labelContent: '<div id="parking-marker" class="de-icon circle medium-size" style="background-color:#5A6E94;"><i class="de-icon-cab"></i></div>',
	...
	*/		
		...
		'<div class="info-window-wrapper">'+
			'<h6>CEREMONY</h6>'+
			'<div class="info-window-desc">Cedar Haven is an enchanting venue among old growth trees in East Sooke.</div>'+
			'<div class="info-window-link"><a href="http://www.cedarhavenweddings.com/" class="grey-link with-underline">More Info</a></div>'+
      	'</div>';
		...
		'<div class="info-window-wrapper">'+
			'<h6>PARKING</h6>'+
			'<div class="info-window-desc">East Sooke Grocer & General Store is available for overflow parking.</div>'+
